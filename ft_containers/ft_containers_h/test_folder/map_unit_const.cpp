...
int main() {
    ...
    // ft::map<int, int, std::plus<int> >    fm;

    // fillMap(m);
    // fillMap(fm);
    // for (std::map<int, int, std::plus<int> >::iterator it = m.begin(); it != m.end(); ++it)
    // { std::cout << (*it).first << std::endl; }
    // std::cout << "------------------" << std::endl;
    // for (ft::map<int, int, std::plus<int> >::iterator it = fm.begin(); it != fm.end(); ++it)
    // { std::cout << (*it).first << std::endl; }
